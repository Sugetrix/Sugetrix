...
-- Copiando dados para a tabela banco_tcc_mtl.tabela_cate_alimento: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela banco_tcc_mtl.tabela_intolerancia: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela banco_tcc_mtl.tabela_usuario: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `tabela_usuario` DISABLE KEYS */;
REPLACE INTO `tabela_usuario` (`Id_Usuario`, `CPF_Usu`, `Nome_Usu`, `Telefone_Usu`, `Email_Usu`, `Senha_Usu`, `Freq_AtivFis_Usu`, `Cod_Doenca_Usu`, `Cod_Renda_Usu`, `Cod_Into_Usu`) VALUES
	(1, '14370690617', 'Talles', '1699978500', 'tallesmiguel0510@gmail.com', 'AA', 0, 1, 1, 1),
	(2, '111111111', 'Seila', NULL, 'algo@gmail.com', 'EE', 0, 0, 0, 0);
